...
export default {
    ...
    computed: {
        canEdit: function () {
            return this.dayjs(this.dayjs().format('YYYY-MM-DD')).isBefore(this.dayjs(this.form.day)) ||
                this.dayjs(this.dayjs().format('YYYY-MM-DD')).isSame(this.dayjs(this.form.day))
        }
    },
    mounted: function () {
